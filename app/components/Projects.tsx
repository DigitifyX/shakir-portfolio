...
// Placeholder project data - will be replaced with Sanity data later
const placeholderProjects = [
  {
    id: "1",
    title: "BadhonAI Portfolio",
    category: "web",
    description: "Personal portfolio website focused on speed, clarity and simple UX.",
  ...
  },
  {
    ...
    category: "uiux",
    description: "Clean analytics dashboard designed with Figma for SaaS style products.",
  ...
  },
  {
    ...
    category: "mobile",
    description: "Mobile app screens for a simple learning / course experience.",
    gradient: "from-blue-400 to-cyan-500",
    link: "#",
    technologies: ["React Native", "Flutter", "UI Design"],
  },
  {
    id: "4",
    title: "Landing Page",
    category: "web",
    description: "Clean landing page designed for modern SaaS / product launches.",
  ...
  },
  {
    ...
    title: "Edit & Motion",
    category: "multimedia",
    description: "Short form edits and motion work for social platforms.",
  ...
  {
    id: "6",
    title: "Mini Product UI",
    category: "uiux",
    description: "Small product UI explorations for practicing new ideas.",
...
function QuickViewPopup({ 
  ...
  project: typeof placeholderProjects[0] | null; 
  isOpen: boolean; 
  onClose: () => void;
}) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative bg-[#0C2029] border border-cyan-500/20 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden"
        style={{
...
function ProjectCard({ 
  ...
  index: number;
  onQuickView: (project: typeof placeholderProjects[0]) => void;
}) {
    ...
    <div
      ...
      style={{
        ...
        background: isHovering 
          ? `radial-gradient(circle 250px at ${mousePosition.x}px ${mousePosition.y}px, rgba(6, 182, 212, 0.12), transparent), #0C2029`
          : '#0C2029',
      }}
    >
...
export default function Projects() {
  ...
  const [quickViewProject, setQuickViewProject] = useState<typeof placeholderProjects[0] | null>(null);
  ...
  const filteredProjects =
    activeFilter === "all"
      ? placeholderProjects
      : placeholderProjects.filter((project) => project.category === activeFilter);
  ...
  const handleQuickView = (project: typeof placeholderProjects[0]) => {
    ...
    <section id="projects" className="py-[35px] md:py-[60px]">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={headerRef} className="mb-8 md:mb-12 text-center">
          ...
          <div ref={tabsRef} className="flex flex-wrap gap-3 justify-center">
